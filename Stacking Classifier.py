# -*- coding: utf-8 -*-
"""
Created on Thu Dec 31 12:15:52 2020
...
results = model_selection.cross_val_score(StackingClassifier(estimators, final_estimator=SGDClassifier()), true_x, true_y, cv=kfold)

pred_y_binary = cross_val_predict(StackingClassifier(estimators, final_estimator=LogisticRegression()), true_x, true_y, cv=kfold)
print(pred_y_binary)
"""
...
results_kfold_acc = model_selection.cross_val_score(StackingClassifier(estimators), true_x, true_y, cv=kfold)
...
ax.set_title("Stacking Class. (SGD, LinearSVC)")
